...
export default function AdminDashboard() {
  ...
  const totalPhotos = events.reduce((sum, event) => sum + event.items.length, 0)
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-muted-foreground mt-1">Manage your events and media</p>
              </div>
            ...
            <div className="grid gap-6 md:grid-cols-3 mb-8">
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-4xl font-bold text-primary">{totalEvents}</CardTitle>
                </CardHeader>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-4xl font-bold text-primary">{totalPhotos}</CardTitle>
                </CardHeader>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-4xl font-bold text-primary">24h</CardTitle>
                </CardHeader>
              </Card>
            </div>
                    ...
                    {events.slice(0, 5).map((event) => (
                      <Link key={event.id} href={`/admin/events/${event.id}`}>
                        <div className="flex items-center gap-4 p-4 rounded-lg border border-border hover:bg-accent/50 transition-colors">
                          ...
                          <div className="text-sm text-muted-foreground">{event.items.length} media</div>
                        </div>
                      </Link>
                    ))}
                  </div>
