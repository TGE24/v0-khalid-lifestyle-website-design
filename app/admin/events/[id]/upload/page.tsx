...
import { uploadImage, uploadVideo, validateFileSize, getFileType } from "@/lib/storage-services"
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">Upload photos and videos from this event</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Select photos and videos to upload from your device</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Select multiple images (max 10MB each) or videos (max 100MB each)
                  </p>
                </div>
            ...
            <Card>
              ...
              <CardContent>
                {selectedFiles.length === 0 ? (
                  <p className="text-center text-muted-foreground py-8">No files selected yet</p>
                ) : (
