          ...
          <div className="grid gap-6 md:grid-cols-3 mb-8">
            <Card>
              <CardHeader>
                ...
                <CardTitle className="text-4xl font-bold text-primary">{event.items.length}</CardTitle>
              </CardHeader>
            </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Manage photos and videos from this event</CardDescription>
                </div>
            ...
            <CardContent>
              {event.items.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <Link href={`/admin/events/${event.id}/upload`}>
                    <Button variant="outline">Add Your First Photo or Video</Button>
                  </Link>
                </div>
              ) : (
