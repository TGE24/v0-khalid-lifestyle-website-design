      ...
      <main className="flex-1 p-8">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-serif font-bold">Create New Event</h1>
              <p className="text-muted-foreground mt-1">Add details for your upcoming or past event</p>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Upload a cover image for the event (max 10MB). You can add more photos after creating the event.
                  </p>
                </div>
