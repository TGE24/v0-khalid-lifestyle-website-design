        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-20">
            <div className="max-w-3xl">
              <span className="text-gold text-xs uppercase tracking-[0.5em] mb-4 block">{event.date}</span>
              <h1 className="text-5xl md:text-7xl font-serif mb-6">{event.title}</h1>
              <p className="text-white/60 text-lg font-light leading-relaxed italic">{event.location}</p>
            </div>
            <p className="text-white/40 max-w-sm text-sm font-light leading-relaxed">{event.description}</p>
          </div>
